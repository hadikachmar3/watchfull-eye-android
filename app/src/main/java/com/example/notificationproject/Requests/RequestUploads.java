...
public class RequestUploads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_uploads);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("requestedimages");
...
//                            String test1 = taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();
    ...
    private void openImagesActivity() {
        Intent intent = new Intent(this, RequestedImagesDisplay.class);
